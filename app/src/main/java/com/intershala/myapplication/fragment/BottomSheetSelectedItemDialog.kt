package com.intershala.myapplication.fragment
...
import com.intershala.myapplication.activity.UserMenuOrderActivity

class BottomSheetSelectedItemDialog : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(
            R.layout.selected_menu_bottom_dialog,
            container,
            false
        )
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<TextView>(R.id.total_ordered_items_price_tv).text = "Rs %.2f".format(totalPrice)
